...
class Tween {
    ...
    public Tween(double Time, EasingService.EasingStyle EaseStyle, EasingService.EasingDirection EaseDirection, Instance targetinst, HashMap<IEnum.Properties, Object> PropertyTarget) {
